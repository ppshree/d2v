...
import { StudentList as StudentListForGlobalTutor } from '../_superadmin/modules/StudentList';
    ...
    <div className="h-full flex">
      <MainLayout>
        <Switch>
          ...
          <Route exact path={APPLICATION_URL.TUTOR_STUDENT_LIST} component={StudentListForGlobalTutor}></Route>
